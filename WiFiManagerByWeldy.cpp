...
void WiFiManager::handleRoot() {
  ...
  page += String(F("<h1 style=\"color:white; padding-bottom:20px;\">"));
  page += _apName;
  page += String(F("</h1>"));
...
void WiFiManager::handleInfo() {
  ...
  page += _customHeadElement;
  page += FPSTR(HTTP_HEAD_END);
  page += F("<table style=\"text-align:left;border:1px solid white;padding: 10px;font-size:20px;\">");
  page += F("<tr><td>Chip ID : </td><td style=\"color:#ffa5a5;font-weight:bold;font-style:italic;\">");
  page += ESP.getChipId();
  page += F("</td></tr>");
  page += F("<tr><td>Flash Chip ID : </td><td style=\"color:#ffa5a5;font-weight:bold;font-style:italic;\">");
  page += ESP.getFlashChipId();
  page += F("</td></tr>");
  page += F("<tr><td>IDE Flash Size : </td><td style=\"color:#ffa5a5;font-weight:bold;font-style:italic;\">");
  page += ESP.getFlashChipSize();
  page += F(" bytes</td></tr>");
  page += F("<tr><td>Real Flash Size : </td><td style=\"color:#ffa5a5;font-weight:bold;font-style:italic;\">");
  page += ESP.getFlashChipRealSize();
  page += F(" bytes</td></tr>");
  page += F("<tr><td>Soft AP IP : </td><td style=\"color:#ffa5a5;font-weight:bold;font-style:italic;\">");
  page += WiFi.softAPIP().toString();
  page += F("</td></tr>");
  page += F("<tr><td>Soft AP MAC : </td><td style=\"color:#ffa5a5;font-weight:bold;font-style:italic;\">");
  page += WiFi.softAPmacAddress();
  page += F("</td></tr>");
  page += F("<tr><td>Station MAC : </td><td style=\"color:#ffa5a5;font-weight:bold;font-style:italic;\">");
