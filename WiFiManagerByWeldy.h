...
#ifndef WiFiManagerByWeldy_h
#define WiFiManagerByWeldy_h
...
const char HTTP_PORTAL_OPTIONS[] PROGMEM  = "<form action=\"/wifi\" method=\"get\"><button>Configurer WiFi</button></form><br/><form action=\"/0wifi\" method=\"get\"><button>Configurer WiFi (Sans scan)</button></form><br/><form action=\"/i\" method=\"get\"><button>Info</button></form><br/><form action=\"/r\" method=\"post\"><button>Reset</button></form>";
...
const char HTTP_SAVED[] PROGMEM           = "<div style=\"margin-top:40px;\"><br/>Le SSID et le mot de passe ont &eacute;t&eacute; sauvegard&eacute;<br/><br/>Tentative de connexion au point d\'acc&egrave;s...<br/><br/>Si la connexion &agrave; &eacute;chou&eacute; reconnectez-vous &agrave; l\'AP et tentez &agrave; nouveau!</div>";
